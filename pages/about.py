...
with st.container():
    ...
    with cl2:
        ...
        st.write("'_Unleashing the Power of NLP Models for Semantic Consistency Checking of Automation Rules_',")
    ...
    with c2:
        st.write("B. Breve, G. Cimino, V. Deufemia, A. Elefante,")
        st.write("'_A BERT-based Model for Semantic Consistency Checking of Automation Rules_',")
        st.write("Proceedings of 29th International DMS Conference on Visualization and Visual Languages (DMSVIVA 2023), San Francisco, 29-30 June, 2023, pp. 87-93, ISSN: 2326-3261")
    ...
    with col2:
        st.write("B. Breve, G. Cimino, V. Deufemia, A. Elefante,")
        st.write("'_User Perception of Risks Associated with IFTTT Applets: A Preliminary User Study_',")
    ...
    with col4:
        ...
        st.write("'_On the User Perception of Security Risks of Trigger-Action Rules: A User Study_',")
